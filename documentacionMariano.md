...
## 🛠️ 2. Aprovisionamiento de la VM (`vm-gateway`)
...
* **Vistas basadas en Roles:** Se implementó una vista de login básico. Dependiendo del rol seleccionado:
  * **Médico / Enfermero:** Solo visualizan el panel de *Estaciones Médicas* (consulta y edición de fichas clínicas).
  * **Administrativo:** Solo visualiza el panel de *Terminales Administrativas* (admisión de pacientes).
